...
export function calculateGreeks(spot, strike, timeToExpiry, volatility, riskFreeRate, type) {
    if (timeToExpiry <= 0) {
...
export function calculateOptionPrice(spot, strike, timeToExpiry, volatility, riskFreeRate, type) {
    if (timeToExpiry <= 0) {
...
export function calculatePayoffCurve(legs, spotRange, steps = 100) {
...
export function calculateStrategyGreeks(legs, spot, timeToExpiry, volatility, riskFreeRate) {
...
export function analyzeOIData(strikes, callOI, putOI, callOIChange, putOIChange, callIV, putIV) {
...
export class OptionsService {
    ...
    computePayoff(legs, spotPrice) {
        const range = [spotPrice * 0.85, spotPrice * 1.15];
    ...
    scenarioSimulation(legs, spotPrice, scenarios) {
