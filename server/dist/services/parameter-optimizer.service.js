...
function isGridRange(r) {
    return 'values' in r;
}
function runBacktest(strategy, bars, initialCapital) {
    const state = {
...
function computeMetrics(state, initialCapital) {
...
export class ParameterOptimizerService {
    gridSearch(strategy, bars, paramRanges, initialCapital) {
    ...
    randomSearch(strategy, bars, paramRanges, initialCapital, iterations) {
...
//# sourceMappingURL=parameter-optimizer.service.js.map